...
{
    public partial class HHTOUT : Form
    {
        public HHTOUT()
        {
            InitializeComponent();
        }
        static SerialPort port2 = new SerialPort(FunctionGeneral.COMRaHHT, 9600, Parity.None, 8, StopBits.One);
        ...
        private void startCamera()
        {
            try
            {
                ...
                videoCapture = new VideoCaptureDevice(filterInfo[FunctionGeneral.CamOUT].MonikerString);
        ...
        public static void goidichvu(string s, long time, string idthe)
        {
            try
            {
                FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_Nhayvaohamgoidichvu_");
                DateTime utcDateTime = DateTime.UtcNow;
                string vnTimeZoneKey = "SE Asia Standard Time";
                TimeZoneInfo vnTimeZone = TimeZoneInfo.FindSystemTimeZoneById(vnTimeZoneKey);
                DateTime ngaygiohientai = TimeZoneInfo.ConvertTimeFromUtc(utcDateTime, vnTimeZone);
                ...
                {
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT__Nhayvaohamgoidichvu_1");
                    ...
                    u5.deviceID = 3;
                    u5.idThietBi = FunctionGeneral.idThietBiHHTCongRa;
                    u5.typeDataAuThen = 3;
                    u5.sdt = "0353465132";
                    u5.idthe = idthe;
                ...
                {
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_Nhayvaohamgoidichvu_2");
                    u5.imgBase64 = s;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_3");
                    u5.uID = "";
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_4");
                    u5.uCodeID = idthe;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_5");
                    u5.thoiGianGhiNhan = yourDateTimeMilliseconds;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_6");
                    u5.deviceID = 3;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_7");
                    u5.idThietBi = FunctionGeneral.idThietBiHHTCongRa;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_8");
                    u5.typeDataAuThen = 0;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_9");
                    u5.sdt = "0353465132";
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_10");
                    u5.idthe = idthe;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_11");
                    u5.name = FunctionGeneral.KeyName;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_12");
                    u5.sothe = FunctionGeneral.KeyViD;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_13");
                    u5.cks = Md5("77a+6Mx2&Ata8mBE" + u5.deviceID + u5.thoiGianGhiNhan + "" + u5.typeDataAuThen).ToLower();
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_14");

                }
                var json7 = JsonConvert.SerializeObject(u5);
                FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_15");
                String res7 = Service.SendWebrequest_POST_Method(json7, url5);
                FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_Nhayvaohamgoidichvu_3" + res7);

            }
            catch (Exception ex)
            {
                FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_HHTOUT_Upload Anh loi: " + ex.Message);
            }
        }


        private void HHTOUT_Load(object sender, EventArgs e)
        {
            label1.Text = "ID Thiết bị: " + FunctionGeneral.idThietBiHHTCongRa + "_Đầu vào: " + FunctionGeneral.COMRaHHT;
            label2.Text = "";
            try
            {
                startCamera();
        ...
        private void CanhBao()
        {
            try
            {
                ...
                FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "goidichvuCanhBao_HHTOUT__1");
                string url = "http://210.245.8.7:12318/vimass/services/VUHF/capNhatTrangThaiHoatDong";
                canhBao.idThietBi = FunctionGeneral.idThietBiHHTCongRa;
                ...
                String res = Service.SendWebrequest_POST_Method(json, url);
                FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "goidichvuCanhBao_HHTOUT__2" + res);
            ...
            try
            {
                ...
                if (true)
                {
                    var action = new Action(() =>
                    {
                        ...
                        FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", timenow + "_HHTOUT_UidFull: " + vUidFull);
                        ...
                        FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", timenow + "_HHTOUT_LISTID " + ListID);
                        ...
                        {
                            FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", timenow + "_HHTOUT_IDTRUNG " + vuIDIn);
                            if (vuIDIn.Length > 5)
                            {
                                DateTime utcDateTime = DateTime.UtcNow;
                                string vnTimeZoneKey = "SE Asia Standard Time";
                                ...
                                FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", timenow + "_HHTOUT_IDFINAL_" + vuIDFinal);
                                ...
                                var actionUploadImg = new Action(() =>
                                {
                                    ...
                                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", timenow + "_HHTOUT_GoiDuocVaoDichVu_" + vuIDFinal);
                                });
        ...
        private string capture()
        {
            try
            {
                ...
                string fileName = @"D:\OUTHHT" + timenow2 + ".jpg";
                var bitmap = new Bitmap(pictureBox1.Width, pictureBox1.Height);
                pictureBox1.DrawToBitmap(bitmap, pictureBox1.ClientRectangle);
