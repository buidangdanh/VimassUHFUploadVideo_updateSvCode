...
{
    public partial class TKOUT : Form
    {
        static SerialPort port2 = new SerialPort(FunctionGeneral.COMRaThuyKhue, 9600, Parity.None, 8, StopBits.One);
        ...
        private void TKOUT_Load(object sender, EventArgs e)
        {
            label1.Text = "ID Thiết bị: " + FunctionGeneral.idThietBiThuyKhueCongRa + "_Đầu vào: " + FunctionGeneral.COMRaThuyKhue;
            label2.Text = "";
            try
            {
                startCamera();
        ...
        private void CanhBao()
        {
            try
            {
                ...
                FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "goidichvuCanhBaoTKCR_1");
                string url = "http://210.245.8.7:12318/vimass/services/VUHF/capNhatTrangThaiHoatDong";
                canhBao.idThietBi = FunctionGeneral.idThietBiThuyKhueCongRa;
                ...
                FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "goidichvuCanhBaoTKCR_2" + res);
        ...
        public static void goidichvu(string s, long time, string idthe)
        {
            try
            {
                FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt",  "_TKCR_Nhayvaohamgoidichvu_");
                DateTime utcDateTime = DateTime.UtcNow;
                string vnTimeZoneKey = "SE Asia Standard Time";
                TimeZoneInfo vnTimeZone = TimeZoneInfo.FindSystemTimeZoneById(vnTimeZoneKey);
                DateTime ngaygiohientai = TimeZoneInfo.ConvertTimeFromUtc(utcDateTime, vnTimeZone);
                ...
                {
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_TKCR_Nhayvaohamgoidichvu_1");
                    ...
                    u5.deviceID = 3;
                    u5.idThietBi = FunctionGeneral.idThietBiThuyKhueCongRa;
                    u5.typeDataAuThen = 3;
                    u5.sdt = "0353465132";
                    u5.idthe = idthe;
                ...
                {
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_TKCR_Nhayvaohamgoidichvu_2");
                    u5.imgBase64 = s;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", " _TKCR_3");
                    u5.uID = "";
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", " _TKCR_4");
                    u5.uCodeID = idthe;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_TKCR_5");
                    u5.thoiGianGhiNhan = yourDateTimeMilliseconds;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_TKCR_6");
                    u5.deviceID = 3;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_TKCR_7");
                    u5.idThietBi = FunctionGeneral.idThietBiThuyKhueCongRa;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_TKCR_8");
                    u5.typeDataAuThen = 0;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_TKCR_9");
                    u5.sdt = "0353465132";
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_TKCR_10");
                    u5.idthe = idthe;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_TKCR_11");
                    u5.name = FunctionGeneral.KeyName;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_TKCR_12");
                    u5.sothe = FunctionGeneral.KeyViD;
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_TKCR_13");
                    u5.cks = Md5("77a+6Mx2&Ata8mBE" + u5.deviceID + u5.thoiGianGhiNhan + "" + u5.typeDataAuThen).ToLower();
                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_TKCR_14");

                }
                var json7 = JsonConvert.SerializeObject(u5);
                FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_TKCR_15");
                String res7 = Service.SendWebrequest_POST_Method(json7, url5);
                FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", "_TKCR_Nhayvaohamgoidichvu_3"+ res7);
        ...
        private void detectID()
        {
            try
            {
                ...
                //FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", timenow + "_TKCR_" + vuid);
                string str4 = "";
                if (true)
                {
                    var action = new Action(() =>
                    {
                        ...
                        FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", timenow + "_TKCR_2_" + vUidFull);
                        ...
                        FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", timenow + "_TKCR_3_" + ListID);
                        ...
                        FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", timenow + "_TKCR_4_" + ListIDTrung);
                        foreach (string vuIDIn in ListIDTrung)
                        {
                            FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", timenow + "_TKCR_5_" + vuIDIn);
                            if (vuIDIn.Length > 5)
                            {
                                DateTime utcDateTime = DateTime.UtcNow;
                                string vnTimeZoneKey = "SE Asia Standard Time";
                                ...
                                var actionUploadImg = new Action(() =>
                                {
                                    ...
                                    FunctionGeneral.writeFile(@"D:\VimassUHFLog.txt", timenow + "_TKCR_6_" + vuIDFinal + "Goidichvuthanhcong");
        ...
        private string capture()
        {
            try
            {
                ...
                string fileName = @"D:\OUTTK" + timenow2 + ".jpg";
                var bitmap = new Bitmap(pictureBox1.Width, pictureBox1.Height);
                pictureBox1.DrawToBitmap(bitmap, pictureBox1.ClientRectangle);
